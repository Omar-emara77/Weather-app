async function getWeather(city) {
    var response = await fetch(
      `https://api.weatherapi.com/v1/forecast.json?key=e8bbcd0496f24c63a20193151241512&q=${city}&days=3`
    );
              ...
              <div class="inner color3 rounded-4 text-white px-0 overflow-hidden">
                ...
                <div class="info px-4">
                  ...
                  >
                    ...
                    <img src="https:${data.current.condition.icon}" alt="icon" class="w-25" onerror="this.src='path/to/default/icon.png';" />
